...
export interface StakeeasyStakeReadOnlyInterface {
  ...
  withdrawAdjustmentData: ({
    ...
    addr: string;
  }) => Promise<WithdrawAdjustmentDataResponse>;
  votingPowerAtHeight: ({
    address,
    height
  }: {
...
export class StakeeasyStakeQueryClient implements StakeeasyStakeReadOnlyInterface {
...
export interface StakeeasyStakeInterface extends StakeeasyStakeReadOnlyInterface {
  contractAddress: string;
  sender: string;
  rebond: ({
    bondFrom,
...
export class StakeeasyStakeClient extends StakeeasyStakeQueryClient implements StakeeasyStakeInterface {
